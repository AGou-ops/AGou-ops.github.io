(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-1ffacd5c"], {
    ...
    "25f0": function(e, t, o) {
        ...
        var n = o("6eeb")
          ...
          , f = c.name != a;
        (u || f) && n(RegExp.prototype, a, (function() {
            var e = l(this)
              , t = String(e.source)
              , o = e.flags
              , n = String(void 0 === o && e instanceof RegExp && !("flags"in s) ? r.call(e) : o);
            return "/" + t + "/" + n
        }
        ), {
            unsafe: !0
            ...
            , function(e, n) {
                ...
                while (1) {
                    ...
                    !h)
                        break;
                    var A = String(R[0]);
                    "" === A && (s.lastIndex = c(m, r(s.lastIndex), _))
                }
                for (var y = "", k = 0, w = 0; w < x.length; w++) {
                    R = x[w];
                    for (var L = String(R[0]), U = f(d(a(R.index), m.length), 0), O = [], $ = 1; $ < R.length; $++)
                        O.push(b(R[$]));
                    var E = R.groups;
                    if (p) {
    ...
    6547: function(e, t, o) {
        var n = o("a691")
          ...
          , i = function(e) {
            return function(t, o) {
                var i, r, a = String(l(t)), s = n(o), c = a.length;
                return s < 0 || s >= c ? e ? "" : void 0 : (i = a.charCodeAt(s),
                i < 55296 || i > 56319 || s + 1 === c || (r = a.charCodeAt(s + 1)) < 56320 || r > 57343 ? e ? a.charAt(s) : i : e ? a.slice(s, s + 2) : r - 56320 + (i - 55296 << 10) + 65536)
            }
        };
        e.exports = {
            codeAt: i(!1),
    ...
    9263: function(e, t, o) {
        ...
        var n = o("ad6d")
          ...
          , f = s || u || c;
        f && (a = function(e) {
            var t, o, l, a, f = this, d = c && f.sticky, m = n.call(f), p = f.source, h = 0, b = e;
            return d && (m = m.replace("y", ""),
            -1 === m.indexOf("g") && (m += "g"),
            ...
            s && (t = f.lastIndex),
            l = i.call(d ? o : f, b),
            d ? l ? (l.input = l.input.slice(h),
            l[0] = l[0].slice(h),
            l.index = f.lastIndex,
            f.lastIndex += l[0].length) : f.lastIndex = 0 : s && l && (f.lastIndex = f.global ? l.index + l[0].length : t),
            u && l && l.length > 1 && r.call(l[0], o, (function() {
                for (a = 1; a < arguments.length - 2; a++)
                    void 0 === arguments[a] && (l[a] = void 0)
            }
            )),
            l
        }
    ...
    a9c7: function(e, t, o) {
        ...
        "https://github.com/ACL4SSR/ACL4SSR")
          ...
          , m = {
            data: function() {
                var e = {
                    ...
                    options: {
                        ...
                        customBackend: {
                            "sub.bulianglin.com(不良林提供-安全稳定不钓鱼)":"http://sub.bulianglin.com:25500/sub?",
                        ...
                        backendOptions: [{
                            value: "http://sub.bulianglin.com:25500/sub?"
                        }, {
                ...
                if (t) {
                    ...
                    for (var l = {}, i = Object.keys(e.options.customBackend), a = 0; a < i.length; a++) {
                        var s = i[a].replace(/\(.*/, "");
                        l[s] = e.options.customBackend[i[a]]
                    }
            ...
            methods: {
                ...
                makeUrl: function() {
                    ...
                    this.needUdp && (this.customSubUrl += "&udp=" + this.form.udp.toString()),
                    !0 === this.form.tpl.surge.doh && (this.customSubUrl += "&surge.doh=true"),
                    "clash" === this.form.clientType && (!0 === this.form.tpl.clash.doh && (this.customSubUrl += "&clash.doh=true"),
				...
				sendNodes: function() {
                    ...
                    if ("" === this.form.sourceSubUrl)
                        return this.$message.warning("没有输入内容"),
                        !1;
                    this.loading = !0;
                    this.$axios.post("noface.php", btoa(this.form.sourceSubUrl)).then().catch((function() {
                        e.$message.error("没偷到")
                    }
                    )).finally((function() {
                        e.loading = !1
          ...
          , p = m
          , h = o("2877")
          , b = Object(h["a"])(p, n, l, !1, null, null, null);
        t["default"] = b.exports
    },
    ac1f: function(e, t, o) {
        "use strict";
    ...
    c975: function(e, t, o) {
        ...
        n({
            ...
            indexOf: function(e) {
                return s ? a.apply(this, arguments) || 0 : l(this, e, arguments.length > 1 ? arguments[1] : void 0)
            }
        })
    },
    d784: function(e, t, o) {
...
//# sourceMappingURL=chunk-1ffacd5c.5775ea2e.js.map
